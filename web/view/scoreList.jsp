		...
		$(function() {
			...
			$("#editDialog").dialog({
				...
				onBeforeOpen: function(){
					...
					$("#edit_score").combobox('setValue',selectRow.grade);
	...
	<form id="addForm" method="post">
		<table cellpadding="8" >
			...
			<tr>
				...
				<td colspan="3">
					<select id="add_score"  class="easyui-combobox" name="grade" style="width:200px;"><option>A</option><option>B</option><option>C</option><option>D</option><option>F</option><option>I</option></select>
				</td>
				<td style="width:80px"></td>
			</tr>
	...
	<form id="editForm" method="post">
		...
		<table cellpadding="8" >
			...
			<tr>
				<td style="width:40px">成绩:</td>
				<td colspan="3">
					<select id="edit_score" class="easyui-combobox"  name="grade" style="width:200px;"><option>A</option><option>B</option><option>C</option><option>D</option><option>F</option><option>I</option></select>
				</td>
				<td style="width:80px"></td>
			</tr>
