...
<meta name="keywords" content="学生信息管理系统-用户登录">
</head>


<body> 

<div class="header" style="padding: 100;">  
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 100px; padding: 0;">吉林大学 | 学生信息管理系统</h2>
</div>
