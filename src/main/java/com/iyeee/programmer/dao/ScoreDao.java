package com.iyeee.programmer.dao;
...
public class ScoreDao extends BaseDao {
	...
	public boolean addScore(Score score){
		String sql = "insert into s_score values(null,"+score.getStudentId()+","+score.getCourseId()+",'"+score.getGrade()+"','"+score.getRemark()+"')";
		return update(sql);
	}
	 ...
	 * @return
	 */
	public List<Score> getGradeList(Score score, Page page) {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getGradeList(Score score) {
		// TODO Auto-generated method stub
	 ...
	 * @return
	 */
	public int getGradeListTotal(Score score) {
		// TODO Auto-generated method stub
		int total = 0;
